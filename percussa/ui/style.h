...
namespace percussa
{
  namespace ui
  {
    namespace style
    {
      ...
      constexpr uint32_t kEncoderShell = PERCUSSA_RGBA(28, 30, 36, 255);
      constexpr uint32_t kEncoderFace = PERCUSSA_RGBA(232, 236, 246, 255);
      constexpr uint32_t kEncoderRim = PERCUSSA_RGBA(86, 92, 108, 255);
